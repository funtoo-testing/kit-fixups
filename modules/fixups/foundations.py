...
class KitFoundation:
	kit_groups = {
		'1.2-release': [
			...
			{'name': 'xfce-kit', 'branch': '4.13-release', 'source': 'funtoo_prime_xfce', 'stability': KitStabilityRating.PRIME},
		...
		'1.3-release': [
			...
			{'name': 'ml-lang-kit', 'branch': '1.2-release', 'source': 'funtoo_current', 'stability': KitStabilityRating.DEV},
